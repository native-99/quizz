        ...
        <div class="col-6">
            <div class="card shadow mb-4 border-bottom-primary">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="{{ route('session.index') }}" class="btn btn-warning btn-sm">
                        {{ __('Back') }}
                    </a>
                </div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        @forelse ($session->related as $activity)
                            <x-box.item :title="$loop->iteration .
                                '- ' .
                                (optional($activity->model)->title ?? 'No Title Available')" :color="$activity->model->color ?? 'default_color'">
                                @if (!$loop->first)
                                    @slot('up')
