            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="attempt" type="number" class="form-control form-control-user" id="attempt"
                                min="0" max="50" placeholder="Attempt"
                                value="{{ $quiz->attempt ?? 'zero is unlimited...' }}">
                            @error('attempt')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="min_pass_score" type="number" class="form-control form-control-user"
                                id="min_pass_score" placeholder="min_pass_score"
                                value="{{ $quiz->min_pass_score ?? '80' }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="random_question" type="number" class="form-control form-control-user"
                                id="random_question" placeholder="random_question"
                                value="{{ $quiz->random_question ?? '0' }}">
                    ...
                    <div class="form-group">
                        <textarea name="description" type="text" class="form-control editor" id="description" placeholder="Description">{{ $quiz->description ?? '' }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
