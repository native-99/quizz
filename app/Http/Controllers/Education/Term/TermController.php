    ...
    public function destroy($term_id)
    {
        ...
        try {
            if ($this->service->destroy($term_id)) {
                ...
                return redirect()->back()->with('danger', 'Silahkan hapus isinya atau relasi yang berkaitan di dalamnya terlebih dahulu.');
            }
        } catch (\Exception $e) {
            return redirect()->back()->with('danger', 'Delete is not Completed, Please check child of this term.');
        }
    }
